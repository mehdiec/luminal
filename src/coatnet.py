...
class CoAtNet(nn.Module):
    def __init__(self, in_ch, image_size, out_chs=[64, 96, 192, 384, 768]):
        ...
        self.s1 = MBConvBlock(
            ksize=3,
            input_filters=out_chs[0],
            output_filters=out_chs[0],
        ...
        self.s3 = ScaledDotProductAttention(
            out_chs[2], out_chs[2] // 8, out_chs[2] // 8, 8
        )
        ...
        self.s4 = ScaledDotProductAttention(
            out_chs[3], out_chs[3] // 8, out_chs[3] // 8, 8
        )
